...
SOURCE = characters.txt	songs.txt world.txt all-dict.txt
TARGET = characters.plist characters.zip songs.plist songs.zip world.zip world.plist all-dict.plist all-dict.zip
